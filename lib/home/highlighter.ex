defmodule Home.Highlighter do
  @moduledoc """
  Performs code highlighting.

  Copied from ExDoc's highlighter at: https://github.com/elixir-lang/ex_doc/blob/d5cde30f55c7e0cde486ec3878067aee82ccc924/lib/ex_doc/highlighter.ex
  """

  # If new lexers are available, add them here:
  defp pick_language_and_lexer(""),
    do: {"elixir", Makeup.Lexers.ElixirLexer, []}
  ...
  defp highlight_code_block(full_block, lang, code, outer_opts) do
    case pick_language_and_lexer(lang) do
      ...
      {language, lexer, opts} ->
        render_code(language, lexer, opts, code, outer_opts)
    end
  end
